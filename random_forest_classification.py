...
""" This file defines the functions for a random forest classifier.
...
########################################################################################################################
#                            Define the Classes to be Used for the Random Forest Classifier                            #
########################################################################################################################


class RandomForestParameters(object):

    def __init__(self, n_estimators=10, criterion='gini', max_depth=None, min_samples_split=2, min_samples_leaf=1,
                 min_weight_fraction_leaf=0., max_features="auto", max_leaf_nodes=None, n_jobs=None):
...
########################################################################################################################
#                  Define the Classes to be Used for the Performances of the Random Forest Classifier                  #
########################################################################################################################


class PerformancesRandomForest(object):
...
########################################################################################################################
#                         Define the Functions for the Training of the Random Forest Classifier                        #
########################################################################################################################


def train_random_forest_classifier(x_train, y_train, random_forest_parameters):

    # Print information in the console
    print("\nThe random forest classifier will be created")

    n_estimators = random_forest_parameters.n_estimators
    criterion = random_forest_parameters.criterion
    max_depth = random_forest_parameters.max_depth
    min_samples_split = random_forest_parameters.min_samples_split
    min_samples_leaf = random_forest_parameters.min_samples_leaf
    min_weight_fraction_leaf = random_forest_parameters.min_weight_fraction_leaf
    max_features = random_forest_parameters.max_features
    max_leaf_nodes = random_forest_parameters.max_leaf_nodes
    n_jobs = random_forest_parameters.n_jobs
    ...
    # Print information in the console
    print("The random forest classifier has been created")
    print("The random forest classifier is training")
    ...
    # Print information in the console
    print("The random forest classifier has done its training process")

    return random_forest_classifier, running_time


########################################################################################################################
#                         Define the Functions for the Testing of the Random Forest Classifier                         #
########################################################################################################################


def test_random_forest_classifier(x_test, random_forest_classifier):

    # Print information in the console
    print("\nThe random forest classifier is being tested with the testing set")
    ...
    # Print information in the console
    print("The random forest classifier has done its testing process")

    return y_test_predicted, running_time


########################################################################################################################
#                    Define the Functions for Computing Performances of the Random Forest Classifier                   #
########################################################################################################################
...
########################################################################################################################
#                  Define the Functions to Display the Results on Graph for the Random Forest Classifier               #
########################################################################################################################
...
def display_features_and_classification_for_rf_classifier(x, y, class_names, random_forest_classifier,
    ...
    if (len(class_names) <= 10) and (number_of_features <= 5):
        ...
        max_features = random_forest_parameters.max_features
        plt.tight_layout()
        plt.suptitle("%i-Class classification (Number of trees = %i, Number of features per tree = '%s')" % (number_of_classes, n_estimators, max_features))
